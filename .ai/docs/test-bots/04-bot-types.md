...
20 копиботов v2 (по одному на окно), MA-боты — закомментированы (`new_bots.py:523-560`).
...
* `get_most_volatile_symbol` в `new_bots.py:117` — медленная Python-версия
  ...
  закомментирован (`new_bots.py:344`). Не путайте с живым выбором пары по
