...
async def create_bots(symbol="BTCUSDT"):
    ...
    async with dsm.get_session() as session:
        ...
        start_ticks_values = [250, 310, 412, 500, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 11000, 12000, 13000, 14000, 15000, 20000, 30000]  # Y axis
        stop_lose_ticks_values = [1, 100, 200, 300, 400, 500, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 20000, 50000]  # X axis
