...
class MarketOrder(BaseId):
    ...
    open_order_type: Mapped[Optional[str]] = mapped_column(
        types.String, nullable=True, comment="Type of order used to open position"
    )
    close_order_type: Mapped[Optional[str]] = mapped_column(
        types.String, nullable=True, comment="Type of order used to close position"
    )
    start_price: Mapped[Optional[float]] = mapped_column(
        types.Numeric, nullable=True, comment="Price at which the order was initiated"
    )
    activation_price: Mapped[Optional[float]] = mapped_column(
        types.Numeric, nullable=True, comment="Price at which the order became active"
    )
    open_price: Mapped[Optional[float]] = mapped_column(
        types.Numeric, nullable=True, comment="Execution price for opening the position"
    )
    close_price: Mapped[Optional[float]] = mapped_column(
        types.Numeric, nullable=True, comment="Execution price for closing the position"
    )
    open_commission: Mapped[Optional[float]] = mapped_column(
        types.Numeric, nullable=True, comment="Commission paid for opening the position"
    )
    close_commission: Mapped[Optional[float]] = mapped_column(
        types.Numeric, nullable=True, comment="Commission paid for closing the position"
    )
    activation_time: Mapped[Optional[datetime]] = mapped_column(
        types.TIMESTAMP, nullable=True, comment="Timestamp when order became active"
    )
    open_time: Mapped[Optional[datetime]] = mapped_column(
        types.TIMESTAMP, nullable=True, comment="Timestamp when position was opened"
    )
    close_time: Mapped[Optional[datetime]] = mapped_column(
        types.TIMESTAMP, nullable=True, comment="Timestamp when position was closed"
    )
    ...
    exchange_status: Mapped[Optional[str]] = mapped_column(
        types.String, nullable=True, comment="Status of the order on the exchange"
    )
    profit_loss: Mapped[Optional[float]] = mapped_column(
