...
async def update_bot_profits():
    ...
    async with (dsm.get_session() as session):
        ...
        profits_data = await bot_crud.get_sorted_by_profit(since=timedelta(hours=1), just_not_copy_bots=True)#since=timedelta(hours=6), just_not_copy_bots=True, just_copy_bots=True
